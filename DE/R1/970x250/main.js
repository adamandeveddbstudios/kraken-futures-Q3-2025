...
function animate() {
  ...
  tl1.to("#gradient", 6, {y: '30px', x: '-70px', ease: Power1.easeInOut, transformOrigin: "center right"})
  .to("#gradient", 6, { y: '0px', x: '0',  ease: Power1.easeInOut})
...
function default_over() {
  TweenMax.to('#cta', 0.3, { scale: 1.1, transformOrigin: '70% 10%', ease: Power2.easeOutIn })
}
